        ...
        <div class="row">
          <div class="col-md-6 mb-4 stretch-card transparent">
            <div class="card card-tale">
              <div class="card-body">
                <p class="mb-4">Policies Sold</p>
                <p class="fs-30 mb-2">{{ $policiesSoldByUserCount }}</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 mb-4 stretch-card transparent">
            <div class="card card-dark-blue">
              <div class="card-body">
                <p class="mb-4">Expired Policies</p>
                <p class="fs-30 mb-2">{{ $expiredPoliciesByUserCount }}</p>
              </div>
            </div>
          </div>
        </div>
