                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="policy-form" class="forms-sample">
                            @csrf
                            <!-- Hidden Fields for Axios Submission -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nextOfKin" placeholder="Enter Next of Kin" required>
                            </div>
...
<script>
    ...
    function processPayment() {
        ...
        const premiumAmount = parseFloat(form.premium_amount.value); // Ensure numeric value
        const amount = Math.round(premiumAmount * 100); // Convert to pesewas (GHS to pesewas)
        ...
        if (!amount || isNaN(amount) || amount <= 0) {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Premium amount must be a valid number!',
            });
            return;
        }
